...
namespace Novu
{
    ...
    public class TopicsSubscribers: ITopicsSubscribers
    {
        ...
        public async Task<TopicsV1ControllerGetTopicSubscriberResponse> GetAsync(string externalSubscriberId, string topicKey, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "TopicsV1Controller_getTopicSubscriber", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TopicSubscriberDto>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TopicSubscriberDto.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
