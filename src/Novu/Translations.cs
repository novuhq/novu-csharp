...
namespace Novu
{
    ...
    public class Translations: ITranslations
    {
        ...
        public async Task<TranslationControllerCreateTranslationEndpointResponse> CreateAsync(CreateTranslationRequestDto createTranslationRequestDto, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "TranslationController_createTranslationEndpoint", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<TranslationControllerGetSingleTranslationResponse> RetrieveAsync(PathParamResourceType resourceType, string resourceId, string locale, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "TranslationController_getSingleTranslation", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<TranslationControllerDeleteTranslationEndpointResponse> DeleteAsync(TranslationControllerDeleteTranslationEndpointPathParamResourceType resourceType, string resourceId, string locale, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "TranslationController_deleteTranslationEndpoint", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<TranslationControllerUploadTranslationFilesResponse> UploadAsync(UploadTranslationsRequestDto uploadTranslationsRequestDto, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "TranslationController_uploadTranslationFiles", new List<string> {  }, SDKConfiguration.SecuritySource);
