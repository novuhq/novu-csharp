...
namespace Novu
{
    ...
    public interface INovuTopics
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="SubscribersControllerListSubscriberTopicsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="SubscribersControllerListSubscriberTopicsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<SubscribersControllerListSubscriberTopicsResponse> ListAsync(
            SubscribersControllerListSubscriberTopicsRequest request,
    ...
    public class NovuTopics: INovuTopics
    {
        ...
        /// <exception cref="ValidationErrorDto">Unprocessable Entity. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<SubscribersControllerListSubscriberTopicsResponse> ListAsync(
            SubscribersControllerListSubscriberTopicsRequest request,
            RetryConfig? retryConfig = null
        )
        {
