...
namespace Novu
{
    ...
    public interface ISubscribersAuthentication
    {

        /// <summary>
        /// Handle providers oauth redirect
        /// </summary>
        Task<SubscribersV1ControllerChatOauthCallbackResponse> OauthCallbackAsync(SubscribersV1ControllerChatOauthCallbackRequest request, RetryConfig? retryConfig = null);
    }

    public class SubscribersAuthentication: ISubscribersAuthentication
    {
        ...
        public SubscribersAuthentication(ISpeakeasyHttpClient client, Func<Novu.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<SubscribersV1ControllerChatOauthCallbackResponse> OauthCallbackAsync(SubscribersV1ControllerChatOauthCallbackRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/v1/subscribers/{subscriberId}/credentials/{providerId}/oauth/callback", request);
            ...
            var hookCtx = new HookContext(baseUrl, "SubscribersV1Controller_chatOauthCallback", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var response = new SubscribersV1ControllerChatOauthCallbackResponse()
                    {
