...
namespace Novu.Models.Components
{
    ...
    public class ThrottleStepResponseDto
    {
        ...
        public ThrottleControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the throttle step
        /// </summary>
        [JsonProperty("controlValues")]
        public ThrottleStepResponseDtoControlValues? ControlValues { get; set; }
