...
namespace Novu.Models.Components
{
    ...
    public class CreateToolWebhookEndpointDto
    {
        /// <summary>
        ...
        public Dictionary<string, CreateToolWebhookEndpointDtoContext>? Context { get; set; }
        ...
        /// </summary>
        [JsonProperty("type")]
        public CreateToolWebhookEndpointDtoType Type { get; set; } = default!;
        ...
        public ToolWebhookEndpointDto Endpoint { get; set; } = default!;
    }
}