...
namespace Novu.Models.Components
{
    ...
    public class UiComponentEnum : IEquatable<UiComponentEnum>
    {
        ...
        public static readonly UiComponentEnum DestinationMethod = new UiComponentEnum("DESTINATION_METHOD");
        public static readonly UiComponentEnum DestinationUrl = new UiComponentEnum("DESTINATION_URL");
        public static readonly UiComponentEnum DestinationHeaders = new UiComponentEnum("DESTINATION_HEADERS");
        public static readonly UiComponentEnum DestinationBody = new UiComponentEnum("DESTINATION_BODY");
        public static readonly UiComponentEnum DestinationResponseBodySchema = new UiComponentEnum("DESTINATION_RESPONSE_BODY_SCHEMA");
        public static readonly UiComponentEnum DestinationEnforceSchemaValidation = new UiComponentEnum("DESTINATION_ENFORCE_SCHEMA_VALIDATION");
        public static readonly UiComponentEnum DestinationContinueOnFailure = new UiComponentEnum("DESTINATION_CONTINUE_ON_FAILURE");
        public static readonly UiComponentEnum DestinationTimeout = new UiComponentEnum("DESTINATION_TIMEOUT");
        ...
        private static readonly Dictionary <string, UiComponentEnum> _knownValues =
            new Dictionary <string, UiComponentEnum> ()
            {
                ...
                ["DESTINATION_HEADERS"] = DestinationHeaders,
                ["DESTINATION_BODY"] = DestinationBody,
                ["DESTINATION_RESPONSE_BODY_SCHEMA"] = DestinationResponseBodySchema,
                ["DESTINATION_ENFORCE_SCHEMA_VALIDATION"] = DestinationEnforceSchemaValidation,
                ["DESTINATION_CONTINUE_ON_FAILURE"] = DestinationContinueOnFailure,
                ["DESTINATION_TIMEOUT"] = DestinationTimeout
            };
