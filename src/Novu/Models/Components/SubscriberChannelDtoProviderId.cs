...
namespace Novu.Models.Components
{
    ...
    public static class SubscriberChannelDtoProviderIdExtension
    {
        public static string Value(this SubscriberChannelDtoProviderId value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SubscriberChannelDtoProviderId ToEnum(this string value)
        {
            foreach(var field in typeof(SubscriberChannelDtoProviderId).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SubscriberChannelDtoProviderId)
                    {
                        return (SubscriberChannelDtoProviderId)enumVal;
                    }
                }
            }
