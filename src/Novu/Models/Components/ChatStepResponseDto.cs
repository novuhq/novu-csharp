...
namespace Novu.Models.Components
{
    ...
    public class ChatStepResponseDto
    {
        ...
        public ChatControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the chat step
        /// </summary>
        [JsonProperty("controlValues")]
        public ChatStepResponseDtoControlValues? ControlValues { get; set; }
        ...
        /// </summary>
        [JsonProperty("slug")]
        public ChatStepResponseDtoSlug Slug { get; set; } = default!;
