...
namespace Novu.Models.Components
{
    ...
    public class ToolStepResponseDto
    {
        /// <summary>
        /// Controls metadata for the tool step.
        /// </summary>
        [JsonProperty("controls")]
        public ToolControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the tool step.
        /// </summary>
        [JsonProperty("controlValues")]
        public ToolStepResponseDtoControlValues? ControlValues { get; set; }
