...
namespace Novu.Models.Components
{
    ...
    public class CreateTelegramChatEndpointDto
    {
        /// <summary>
        ...
        public Dictionary<string, CreateTelegramChatEndpointDtoContext>? Context { get; set; }
        ...
        /// </summary>
        [JsonProperty("type")]
        public CreateTelegramChatEndpointDtoType Type { get; set; } = default!;

        /// <summary>
        /// Telegram chat endpoint data.
        /// </summary>
        [JsonProperty("endpoint")]
        public TelegramChatEndpointDto Endpoint { get; set; } = default!;
    }
}