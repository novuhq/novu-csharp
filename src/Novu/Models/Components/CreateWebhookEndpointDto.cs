...
namespace Novu.Models.Components
{
    ...
    public class CreateWebhookEndpointDto
    {
        ...
        public Dictionary<string, CreateWebhookEndpointDtoContext>? Context { get; set; }
        ...
        /// </summary>
        [JsonProperty("type")]
        public CreateWebhookEndpointDtoType Type { get; set; } = default!;

        /// <summary>
        /// Webhook endpoint data.
        /// </summary>
        [JsonProperty("endpoint")]
        public WebhookEndpointDto Endpoint { get; set; } = default!;
    }
}