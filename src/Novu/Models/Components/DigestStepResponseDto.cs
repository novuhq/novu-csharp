...
namespace Novu.Models.Components
{
    ...
    public class DigestStepResponseDto
    {
        ...
        public DigestControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the digest step
        /// </summary>
        [JsonProperty("controlValues")]
        public DigestStepResponseDtoControlValues? ControlValues { get; set; }
        ...
        /// </summary>
        [JsonProperty("slug")]
        public DigestStepResponseDtoSlug Slug { get; set; } = default!;
