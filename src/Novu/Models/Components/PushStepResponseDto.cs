...
namespace Novu.Models.Components
{
    ...
    public class PushStepResponseDto
    {
        ...
        public PushControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the push step
        /// </summary>
        [JsonProperty("controlValues")]
        public PushStepResponseDtoControlValues? ControlValues { get; set; }
        ...
        /// </summary>
        [JsonProperty("slug")]
        public PushStepResponseDtoSlug Slug { get; set; } = default!;
