...
namespace Novu.Models.Components
{
    ...
    public class CreateWebexPersonEndpointDto
    {
        /// <summary>
        ...
        public Dictionary<string, CreateWebexPersonEndpointDtoContext>? Context { get; set; }
        ...
        /// </summary>
        [JsonProperty("type")]
        public CreateWebexPersonEndpointDtoType Type { get; set; } = default!;

        /// <summary>
        /// Webex person endpoint data. Provide exactly one of personId or personEmail.
        /// </summary>
        [JsonProperty("endpoint")]
        public WebexPersonEndpointDto Endpoint { get; set; } = default!;
    }
}