...
namespace Novu.Models.Components
{
    ...
    public class SmsStepResponseDto
    {
        ...
        public SmsControlsMetadataResponseDto Controls { get; set; } = default!;

        /// <summary>
        /// Control values for the SMS step
        /// </summary>
        [JsonProperty("controlValues")]
        public SmsStepResponseDtoControlValues? ControlValues { get; set; }
        ...
        /// </summary>
        [JsonProperty("slug")]
        public SmsStepResponseDtoSlug Slug { get; set; } = default!;
