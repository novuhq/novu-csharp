...
namespace Novu
{
    ...
    public interface ISubscribersPreferences
    {
        ...
        /// </remarks>
        /// </summary>
        Task<SubscribersControllerGetSubscriberPreferencesResponse> ListAsync(string subscriberId, Criticality criticality, string? idempotencyKey = null, RetryConfig? retryConfig = null);
    ...
    public class SubscribersPreferences: ISubscribersPreferences
    {
        ...
        public async Task<SubscribersControllerGetSubscriberPreferencesResponse> ListAsync(string subscriberId, Criticality criticality, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
