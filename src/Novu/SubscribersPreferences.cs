...
namespace Novu
{
    ...
    public class SubscribersPreferences: ISubscribersPreferences
    {
        ...
        public SubscribersPreferences(ISpeakeasyHttpClient client, Func<Novu.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<SubscribersControllerGetSubscriberPreferencesResponse> ListAsync(string subscriberId, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "SubscribersController_getSubscriberPreferences", new List<string> {  }, _securitySource);
        ...
        public async Task<SubscribersControllerUpdateSubscriberPreferencesResponse> UpdateAsync(string subscriberId, PatchSubscriberPreferencesDto patchSubscriberPreferencesDto, string? idempotencyKey = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "SubscribersController_updateSubscriberPreferences", new List<string> {  }, _securitySource);
