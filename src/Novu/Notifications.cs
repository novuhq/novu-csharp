...
namespace Novu
{
    ...
    public interface INotifications
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="NotificationsControllerListNotificationsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="NotificationsControllerListNotificationsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<NotificationsControllerListNotificationsResponse> GetAsync(
            NotificationsControllerListNotificationsRequest? request = null,
        ...
        /// </remarks>
        /// <param name="notificationId">Description not available.</param>
        /// <param name="idempotencyKey">A header for idempotency purposes.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="NotificationsControllerGetNotificationResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="notificationId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ErrorDto">Bad Request. Thrown when the API returns a 400, 401, 403, 404, 405, 409, 413, 414, 415 or 500 response.</exception>
        /// <exception cref="ValidationErrorDto">Unprocessable Entity. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<NotificationsControllerGetNotificationResponse> RetrieveAsync(
    ...
    public class Notifications: INotifications
    {
        ...
        /// <exception cref="ValidationErrorDto">Unprocessable Entity. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<NotificationsControllerListNotificationsResponse> GetAsync(
            NotificationsControllerListNotificationsRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
        ...
        /// <exception cref="ValidationErrorDto">Unprocessable Entity. Thrown when the API returns a 422 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<NotificationsControllerGetNotificationResponse> RetrieveAsync(
            string notificationId,
            string? idempotencyKey = null,
            RetryConfig? retryConfig = null
        )
