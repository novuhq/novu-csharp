...
<!-- UsageSnippet language="csharp" operationID="EnvironmentVariablesController_getEnvironmentVariable" method="get" path="/v1/environment-variables/{variableKey}" -->
```csharp
using Novu;
using Novu.Models.Components;
...
var res = await sdk.EnvironmentVariables.RetrieveAsync(variableKey: "BASE_URL");
...
<!-- UsageSnippet language="csharp" operationID="EnvironmentVariablesController_updateEnvironmentVariable" method="patch" path="/v1/environment-variables/{variableKey}" -->
```csharp
using Novu;
using Novu.Models.Components;
...
<!-- UsageSnippet language="csharp" operationID="EnvironmentVariablesController_deleteEnvironmentVariable" method="delete" path="/v1/environment-variables/{variableKey}" -->
```csharp
using Novu;
using Novu.Models.Components;
...
var res = await sdk.EnvironmentVariables.DeleteAsync(variableKey: "BASE_URL");
...
<!-- UsageSnippet language="csharp" operationID="EnvironmentVariablesController_getEnvironmentVariableUsage" method="get" path="/v1/environment-variables/{variableKey}/usage" -->
```csharp
using Novu;
using Novu.Models.Components;
...
var res = await sdk.EnvironmentVariables.UsageAsync(variableKey: "BASE_URL");
